        ...
        >
            ...
            <div
                ...
                className={cn(
                    ...
                    variant === "floating" || variant === "inset"
                        ...
                        : (collapsible === "icon" ? "!w-[var(--sidebar-width-icon)]" : "group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)]")
                )}
            />
            <div
            ...
            >
                <div
                    ...
                    className="bg-white z-50 shadow-xl group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
                >
                    {children}
                </div>
            </div>
...
function SidebarSeparator({ className, ...props }) {
    return (
        <Separator
            ...
            className={cn("bg-sidebar-border mx-2 w-auto group-data-[collapsible=icon]:mx-auto group-data-[collapsible=icon]:w-8", className)}
            {...props}
        />
    )
}
